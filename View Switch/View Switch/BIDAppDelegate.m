        ...
        didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    CGRect swtichViewFrame = switchView.frame;
    swtichViewFrame.origin.y += [UIApplication sharedApplication].statusBarFrame.size.height;
    switchView.frame = swtichViewFrame;
